...
export default function EditPatientModal({ patientData, handlePatientData }: any) {
  ...
  useEffect(() => {
    ...
    setDeposit(patientData.deposit);
    setInterest(patientData.interest);
    setBonus(patientData.bonus);
  }, []);
  ...
  const handleSubmit = async (e: any) => {
    ...
    try {
      ...
      if (res.ok) setSuccess("User Updated SuccessFully...");
      ...
      <div className="relative w-full max-w-2xl max-h-full">
        ...
        >
          ...
          <div className="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
            ...
            <button
              onClick={() => handlePatientData(null)}
              type="button"
            ...
            <div className="grid grid-cols-6 gap-6">
              <div className="col-span-6 sm:col-span-3">
                ...
                <input
                  ...
                  placeholder={patientData.fullName}
                  required
                />
              </div>
              ...
              <div className="col-span-6 sm:col-span-3">
                ...
                <select
                  ...
                  className="editUserInput"
                >
                  <option value="none">{patientData.country}</option>
              ...
              <div className="col-span-6 sm:col-span-3">
                ...
                <input
                  ...
                  id="zipCode"
                  className="editUserInput"
                  placeholder={patientData.zipCode}
                  required
                />
              </div>
              ...
              <div className="col-span-3 sm:col-span-2">
                ...
                <input
                  ...
                  id="deposit"
                  className="editUserInput"
                  placeholder={patientData.deposit}
                  required
                  min={0}
                />
              </div>
              ...
              <div className="col-span-3 sm:col-span-2">
                ...
                <input
                  ...
                  id="interest"
                  className="editUserInput"
                  placeholder={patientData.interest}
                  required
                  min={0}
                />
              </div>
